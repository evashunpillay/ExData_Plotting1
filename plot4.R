...
# plot 4.1
plot(power_table_sub$Time, power_table_sub$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
# plot 4.2
plot(power_table_sub$Time, power_table_sub$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
# plot 4.3
...
par(new = TRUE)
legend("topright", lty = c(1,1,1), col = c("black","blue","red"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lwd=c(1,1,1), cex = 0.5)
# plot 4.3
plot(power_table_sub$Time, power_table_sub$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
